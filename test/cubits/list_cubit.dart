...
class ListCubit extends HydratedStateNotifier<List<String>> {
  ListCubit() : super(const <String>[]);

  void addItem(String item) => state = (List.from(state)..add(item));
...
class ListCubitList<T extends ToJsonList<E>, E>
    extends HydratedStateNotifier<List<T>> {
